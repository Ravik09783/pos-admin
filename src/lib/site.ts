...
export const SITE_KEYWORDS: string[] = [
    ...
    "UPI payments", "Paytm POS", "Paytm UPI", "card payments restaurant",
...
export const SITE_FEATURES: string[] = [
    ...
    "Paytm UPI, card & cash payments with auto-confirmation",
...
export const SITE_FAQ: ReadonlyArray<{ q: string; a: string }> = [
    ...
    { q: "How do payments work — does the money come to me?", a: "Yes, directly. In India you connect your own Paytm for Business account (free) — paste your MID + Merchant Key into our settings, and customers pay you by UPI. Money lands in your bank account; we never touch the funds. UPI is 0% MDR (effectively free)." },
